  ...
  if(path.y > 400 ){
    ...
    if (cashG.isTouching(boy)) {
      ...
      jewelryG.destroyEach();
       ...
       //treasureCollection=+ 150;nononono
       //treasureCollection= 150;nononono
       //treasureCollection= treasureCollection - 150;nononono
      ...
      if(swordGroup.isTouching(boy)) {
        ...
        boy.scale=0.6;
         ...
         //diamondsG.destroyEach;
         //jewelryG.destroyEach;
         //swordGroup.destroyEach;nonononono

         //cashG.destroy();
         //diamondsG.destroy();
         //jewelryG.destroy();
         //swordGroup.destroy();nonononono
